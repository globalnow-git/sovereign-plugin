					...
					<tr>
						...
						<td>
							<div class="sb-forms-actions">
								<a href="<?php echo esc_url( admin_url( "admin.php?page=sb-tiny-forms&action=edit&id={$form->id}" ) ); ?>" class="sb-forms-btn sb-forms-btn-primary">Edit</a>
								<a href="<?php echo esc_url( admin_url( "admin.php?page=sb-submissions&form={$form->slug}" ) ); ?>" class="sb-forms-btn">View</a>
							</div>
						</td>
					</tr>
					<?php endforeach; ?>
