...
class SB_Many_Roads {
	...
	/**
	 * Handle a signal trigger — evaluate road routing rules.
	 */
	public static function on_signal_triggered( string $signal_type, $value, int $user_id ): void {
		// Road routing based on signal type is handled via Journey engine.
		// This hook is reserved for future Many Roads signal-based routing logic.
		do_action( 'sb_many_roads_signal', $signal_type, $value, $user_id );
	}
